...
n3: (sel) => {
    ...
    g.arrow(-3.4, {tail: "6"}).config({shift: [-2, 0.2]}).css("blue");
    g.arrow(3.4, {tail: "6"}).config({shift: [2, 0.2]}).css("red");

    g = svg.group("symbol", "f28");
    let Ff = [0, ["F", 1], ["→", 5, [0, "20"]], ["f", 6, ["14", "-8"]]];
    g.symb(...Ff).align([-2, 0.4], "bottom").css("blue");
...
pool: (sel) => {
    ...
    let circ = svg.group("black1", {"fill-opacity": 0.4});
    g = circ.group("red");
    g.circle(1, [-2.4, 5.5]);
    g.circle(1, [0, 1.5]);
    g = circ.group("blue");
    ...
    g.symb(...v).align([4.1, 1.7], 0.5, 1).css("blue");
...
rocket: (sel) => {
    ...
    g.arrow({tail: [0, -1.5], tip: [0, -3.5]}, {tail: "6"}).css("blue");

    g = svg.group("symbol", "f28");
    let Fa = [0, ["F", 1], ["→", 5, [0, "20"]], ["a", 6, ["12", "-8"]]];
    g.symb(...Fa).align([-0.7, 3.8]).css("red");
    g.symb(...Fa).align([-0.7, -2.3]).css("blue");
},
