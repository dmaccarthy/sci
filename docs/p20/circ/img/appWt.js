...
car: (sel) => {
    let svg = new SVG2(sel, {size: [400, 168], lrbt: [-1, 1, -0.55]});
    let r = 3;
...
loop: (sel) => {
    let svg = new SVG2(sel, {size: [400, 180], lrbt: [-2, 2, -1.6]});
...
rope: (sel) => {
    let svg = new SVG2(sel, {size: [512, 488], lrbt: [-1, 1, -0.63]});
...
book: (sel) => {
    let svg = new SVG2(sel, {size: [400, 400], lrbt: [-1.1, 1.1]});
    let a = -20;
