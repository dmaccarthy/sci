...
flow2: (sel) => {
    ...
    svg.energy_flow({radius: 4,
        ...
        arrows: [
            [3, [-4.5, 1.25], -35, ["9.0 J", shift], "red"],
            [3, null, 0, ["5.0 J", shift]],
            [-3, [-4.5, -1.25], 35, ["1.0 J", shift], "red"],
        ]
    });
    let i = 0;
...
F2: (sel, Wg, dW, unit) => {
    ...
    svg.energy_flow({radius: 4,
        ...
        arrows: [
            [3, [5, 0], 0, [`${dW} ${unit}`, ["-6", "16"]], "red"],
            [3, null, 0, [`${Wg} ${unit}`, ["-8", "16"]]],
        ]
    });
},
...
F4: (sel) => {
    ...
    svg.energy_flow({radius: 3,
        ...
        arrows: [
            [2.75, [-2.1, 0], 0, ["50.0 kJ", ["-2", "-16"]], "red"],
            [2.75, [2.1, 0], 0, ["15.0 kJ", ["-8", "-16"]], "red"],
        ]
    });
},
