...
_({page: "web", icon: "html5", title: "Client-Side Scripting"});
_({page: "ct1", icon: "laptop", title: "Computing Science 1"});
}
...
_({page: "pp", icon: "python", title: "Procedural Programming"});
_({page: "ds", icon: "python", title: "Data Structures"});
_({page: "game", title: "Game Project"});
_({page: "robo", icon: "robot", title: "Robotics Programming"});
_({page: "fs", icon: "laptop", title: "Files & File Structures"});
}
...
{ // FS
_ = d => home.item("cs/cs20/fs", d);
_({page: "sys", title: "File Systems"});
_({page: "read", title: "Reading Text Files"});
_({page: "write", title: "Writing Text Files"});
_({page: "access", title: "Sequential & Direct Access"});
_({page: "bin", title: "Binary files"});
_({page: "indx", title: "Indexing Files"});
}

{ // CS 30...
_ = d => home.item("cs/cs30", d);
_({page: "iter", icon: "python", title: "Iterative Algorithms"});
_({page: "oop", icon: "python", title: "Object-Oriented Programming"});
_({page: "rec", icon: "python", title: "Recursive Algorithms"});
_({page: "dds", icon: "python", title: "Dynamics Data Structures"});
}
