...
_ = d => home.item("p30", d);
_({page: "mom", icon: "crash", title: "Momentum & Impulse", data: {cal: false, s: "2027.2.1"}});
_({page: "", icon: "spark", title: "Electric Fields", data: {cal: false}});
_({page: "", icon: "magnet", title: "Magnetic Fields", data: {cal: false}});
_({page: "", icon: "lightbulb", title: "Electromagnetic Waves", data: {cal: false}});
_({page: "", icon: "microscope", title: "Optics", data: {cal: false}});
