SVG2.cache("p30/mag/img/helix.js", {
    ...
    ucm: (sel) => {
        ...
        /* Vector labels */
        let B = '<tspan class="Bold">B</tspan><tspan class="F15" dx="-20" dy="-22">→</tspan>';
        let v = '<tspan class="Bold">v</tspan><tspan class="F15" dx="-16" dy="-12">→</tspan>';
        let Fm = '<tspan class="Bold">F</tspan><tspan class="F15" dy="8">m</tspan><tspan class="F18" dx="-30" dy="-28">→</tspan>';

        /* Magnetic field */
        let c = {fill: "green"};
        svg.circle(0.1).css({fill: "none", stroke: c.fill});
        svg.text("×", [0, "-3"]).css(c);
        svg.text(B, [-0.25, -0.05]).addClass("Symbol").css(c);
        ...
        g.text(v, [0.8, 0.25]).addClass("Symbol").css(c);
        ...
        g.text(Fm, [0.8, -0.25]).addClass("Symbol").css(c);
