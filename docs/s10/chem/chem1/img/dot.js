scripts.cache["s10/chem/chem1/img/dot"] = {

element_data: [/* 0 = solid, 1 = liquid, 2 = gas, 3 = synth / 4 * (0 = metal, 1 = non, 2 = metalloid, 3 = unknown) */
    ...
    ["Hf"], ["Ta"], ["W"], ["Re"], ["Os"], ["Ir"], ["Pt"], ["Au"], ["Hg", 1], ["Tl"], ["Pb"], ["Bi"], ["Po"], ["At", 4], ["Rn", 6],
    ["Fr"], ["Ra"],
...
pt: (sel, diatomic) => {
    ...
    let data = scripts.cache["s10/chem/chem1/img/dot"].element_data;
    let elements = [];
    let r = 0, c = 0;
