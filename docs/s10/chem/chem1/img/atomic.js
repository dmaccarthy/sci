scripts.cache["s10/chem/chem1/img/atomic"] = {
...
nuclear: (sel) => {
    let svg = scripts.cache["s10/chem/chem1/img/atomic"].rutherford(sel);
    // let svg = SVG2.cache_run("s10/chem/chem1/img/atomic.js", "rutherford", sel);
...
bun_alpha: (sel) => {
    let svg = SVG2.cache_run("s10/chem/chem1/img/atomic.js", "bun", sel);
